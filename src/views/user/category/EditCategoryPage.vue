    ...
    export default {
        ...
        methods: {
            getCategoryData(id){
                ...
                axios.get(`http://alexmedia.alexlucifer.info/api/user/category/getItem/${id}`,{headers:this.header}).then((response)=>{
            ...
            updateCategory () {
                ...
                if (this.categoryName==''|| this.categoryName==null) {
                    ...
                    axios.post('http://alexmedia.alexlucifer.info/api/user/category/update',data,{headers:this.header}).then((response)=>{
