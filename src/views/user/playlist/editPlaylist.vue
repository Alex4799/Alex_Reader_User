        ...
        methods: {
            editPlaylist(){
                ...
                if (this.playListData.name=="" || this.playListData.name==null) {
                    ...
                    axios.post(`https://alexmedia.alexlucifer.com/api/user/playlist/update`,this.playListData,{headers:this.header}).then((response)=>{
            ...
            getPlaylist(){
                axios.get(`https://alexmedia.alexlucifer.com/api/user/playlist/edit/${this.$route.params.id}`,{headers:this.header}).then((response)=>{
