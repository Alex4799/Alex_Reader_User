    ...
    export default {
        ...
        methods: {
            getData () {
                ...
                axios.get(`https://alexmedia.alexlucifer.com/api/user/playlist/item/${this.$route.params.id}`,{headers:this.header}).then((response)=>{
            ...
            removePost(id){
                this.loadingStatus=true;
                axios.get(`https://alexmedia.alexlucifer.com/api/user/playlist/item/remove/${id}/${this.$route.params.id}`,{headers:this.header}).then((response)=>{
                    this.posts=response.data.posts;
                    for (let i = 0; i < this.posts.length; i++) {
                        if (this.posts[i].image!=null) {
                            this.posts[i].image=`https://alexmedia.alexlucifer.com/storage/${this.posts[i].image}`;
