...
<script>
    ...
    export default {
        ...
        methods: {
            getUser () {
                axios.get(`https://alexmedia.alexlucifer.com/api/user/get/${this.$route.params.id}`,{headers:this.header}).then((response)=>{
            ...
            getMyPost(page=1){
                axios.get(`https://alexmedia.alexlucifer.com/api/user/mypost/get/${this.$route.params.id}?page=${page}`,{headers:this.header}).then((response)=>{
