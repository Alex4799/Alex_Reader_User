        ...
        methods: {
            getReplyEmail () {
                ...
                if (this.sendData.reply_id!=0) {
                    axios.get(`http://alexmedia.alexlucifer.info/api/user/message/reply/email/${this.sendData.reply_id}`,{headers:this.header}).then((response)=>{
            ...
            sendMessage(){
                ...
                if (!this.error.receive_email && !this.error.title && !this.error.content) {
                    axios.post(`http://alexmedia.alexlucifer.info/api/user/message/send`,this.sendData,{headers:this.header}).then((response)=>{
